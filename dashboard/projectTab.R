    ...
    column(width = 9,
           box(width = NULL, solidHeader = TRUE,
               ...
               "Recently, a start-up company, GEM, was formed out of the University of
                ...
                2012 with initial seed funding of US$2million. The company built its
                2,500m2 facility in a one-hectare land area in Bangkal, Lapu-lapu City, Cebu.",
               p(),
               "The aim of this focus area is to make use of Wireless Sensor Network
                ...
                waste processing, thus leading to increased viability and scale of
                operation. The outcome will therefore be to increase the viability of
                ...
                processing only takes waste from 1 of 36 plants in the region), thus
                leading to job creation and increasing social wealth in disadvantaged
                communities in the local region. Furthermore, it is envisaged that
               ...
               tags$ol(
                 tags$li("Solar drying facility where direct solar energy is harnessed and
                         ...
                         process conditions inside the facility such as temperature, humidity,
                         light intensity and so on, in order to characterise and model its
                         ...
                         and/or the design of the solar power generation system so as to
                         achieve high productivity, yield and cost-efficiency. Further, WSNs
                 ...
                 tags$li("WSNs will be deployed in a prototype tunnel dryer used in the
                        facility, which is used to dry the high-value products from mango
                        wastes, such as mango flour, mango tea, pectin, and others. Data
