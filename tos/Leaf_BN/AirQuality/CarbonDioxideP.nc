/* CarbonDioxideP.nc - Configure ADC0 to sample CO2 Sensor
...
===========================
Carbon Dioxide Configurator
===========================

  CarbonDioxideP is the program file which configures the interface 
needed to sample the  CO2 sensor on ADC0.
