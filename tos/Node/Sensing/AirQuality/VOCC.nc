/* CarbonDioxideP.nc - Wires interfaces needed to sample VOC sensor on ADC0
...
Wires interfaces needed to sample VOC sensor on ADC0
...
implementation {
  ...
  components VOCP;
  AdcReadClientC.AdcConfigure -> VOCP;
  AdcReadStreamClientC.AdcConfigure -> VOCP;
}
