...
implementation
{
  ...
  event void Boot.booted(){
    ...
    call ReadTempADC0.init(SIP_TEMPADC_THRESH, SIP_TEMPADC_MASK, SIP_TEMPADC_ALPHA, SIP_TEMPADC_BETA);
    call ReadTempADC1.init(SIP_TEMPADC_THRESH, SIP_TEMPADC_MASK, SIP_TEMPADC_ALPHA, SIP_TEMPADC_BETA);
    call ReadTempADC2.init(SIP_TEMPADC_THRESH, SIP_TEMPADC_MASK, SIP_TEMPADC_ALPHA, SIP_TEMPADC_BETA);
    call ReadTempADC3.init(SIP_TEMPADC_THRESH, SIP_TEMPADC_MASK, SIP_TEMPADC_ALPHA, SIP_TEMPADC_BETA);
    call ReadFlowADC1.init(SIP_FLOW_THRESH, SIP_FLOW_MASK, SIP_FLOW_ALPHA, SIP_FLOW_BETA);
    call ReadFlowADC3.init(SIP_FLOW_THRESH, SIP_FLOW_MASK, SIP_FLOW_ALPHA, SIP_FLOW_BETA);
    call ReadFlowADC7.init(SIP_FLOW_THRESH, SIP_FLOW_MASK,SIP_FLOW_ALPHA, SIP_FLOW_BETA);
    call ReadSolar.init(SIP_SOLAR_THRESH, SIP_SOLAR_MASK, SIP_SOLAR_ALPHA, SIP_SOLAR_BETA);
    call ReadSolarADC3.init(SIP_SOLAR_THRESH, SIP_SOLAR_MASK, SIP_SOLAR_ALPHA, SIP_SOLAR_BETA);
    call ReadBlackBulb.init(SIP_BLACKBULB_THRESH, SIP_BLACKBULB_MASK, SIP_BLACKBULB_ALPHA, SIP_BLACKBULB_BETA);
