...
<form>
  ...
  <button  id="StopDep">End Deployment</button>
</form>
...
<button id="regNodeGrd">Register Node</button>
<button id="unRegNode">Unregister Node</button>
<button id="clearNode">Clear</button>
<button id="updateNode">Refresh</button>
...
<div calss="dijitHidden">
  <div data-dojo-type="dijit/Dialog" id="regDlg" style="width:600px;" data-dojo-props="title:'Register Node'">
    <form>
      <dl>
