...
<%block name="pagecontent">
     ...
     <section>
       ...
       <table class="table table-hover table-bordered" id="activehouses">
	 <thead>
	   <tr>
	     <th>Id</th>
	     <th>Address</th>
     ...
     <section>
       ...
       <table class="table table-hover table-bordered" id="recentnodes">
	 <thead>
	   <tr>
	     <th>NodeId</th>
     ...
     <section>
       <h3>Missing Nodes</h3>
       <table class="table table-hover table-bordered" id="missingnodes">
	 <thead>
	   <tr>
	     <th>NodeId</th>
	     <th>Last TX (Local Time)</th>
