...
<%block name="scripts">
  ...
  <script type="text/javascript" src="${request.static_url('cogentviewer:jslibs/Highstock/js/highcharts-more.js')}"></script>	
...
<script type="text/javascript" src="${request.static_url('cogentviewer:static/scripts/rrdplot.js')}"></script>
</%block>
