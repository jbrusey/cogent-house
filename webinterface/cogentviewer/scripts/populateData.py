    ...
    sensorList = [SensorType(id=0,name="Temperature",
                 ...
                 SensorType(id=21,name="Delta VOC",
                  ...
                  SensorType(id=22,name="Delta AQ",
                             ...
                             units="v/s",
                             c0=0., c1=1., c2=0., c3=0.),
                  SensorType(id=40,name="Opti Smart Count",
                            code="imp",
                             units="imp",
                             c0=0., c1=1., c2=0., c3=0.),
                  SensorType(id=41,name="Temperature ADC0",
                             code="T",
                             units="deg.C",
                             c0=0., c1=1., c2=0., c3=0.),
                 SensorType(id=42,name="Delta Temperature ADC0",
                            code="dT",
                            units="deg.C/s",
                            c0=0., c1=1., c2=0., c3=0.),
                  SensorType(id=43,name="Gas Pulse Count",
                            code="imp",
                             units="imp",
                             c0=0., c1=1., c2=0., c3=0.),
