...
class ClassyDiffTest(base.BaseTestCase):
    ...
    This set of unittests looks at the diff-dict when classes are
    stored as the objects.

    .. warning::  This depends on the implmentation of the
        equality functions in the class.
    """
