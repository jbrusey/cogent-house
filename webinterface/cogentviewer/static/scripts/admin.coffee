...
#Seperate this into two seperate sets of functionality
...
require([
    ...
    (jsonRest,Cache,Observable,Memory,OnDemandGrid,Keyboard,Selection,editor,DijitRegistry,declare,DateTimeBox,FilteringSelect,ready,parser,Button,Dialog) ->
        ...
        #         editor({label:"Type", field:"roomTypeId", editor:FilteringSelect, editorArgs:{store:typeStore,style:"width:150px",labelProperty:"name",labelArrt:"name"}})
        #         ]
        #     store:roomStore
        #     }
        #     "roomGrid"
        ...
        deployNew = new Button({
            ...
            onClick: -> registry.byId("depDlg").show()
            }
            "deployNew"
            )
        deployNew.startup()

        # deployDelete = new Button({
        #     label:"Delete"
        #     onClick: ->
