...
try:
    ...
    wsgi_app = appconfig('config:' + config_file,relative_to=".") #Load using pyramid
...
def run_migrations_online():
    ...
    # engine = meta.engine
    engine = engine_from_config(wsgi_app,prefix="sqlalchemy.") #Load engine
