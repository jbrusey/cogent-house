...
def populateSensorTypes(session = False):
    ...
    sensorList = [SensorType(id=0, name="Temperature",
                  ...
                  SensorType(id=24, name="Temperature Cold",
                             ...
                             units= "%",
                             c0=0., c1=1., c2=0., c3=0.),
                  # SensorType(id=20, name="Electricity pulses",
                  #           code="EP",
                  #           units="p",
                  #           c0=0., c1=1., c2=0., c3=0.),
                  # SensorType(id=21, name="Temp ADC1",
                  #            code="TA1",
                  #            units="deg.C",
                  #            c0=0., c1=1., c2=0., c3=0.),
                  # SensorType(id=22, name="Temp ADC2",
                  #            code="TA2",
                  #            units="deg.C",
                  #            c0=0., c1=1., c2=0., c3=0.),
                  ...
                  #            code="plogg_a",
                  #            units="A"),
                  # SensorType(id=52, name="Plogg Wattage",
                  #            code="plogg_w",
                  #            units="W"),
                  #- From Alembic (Revisions)
                  SensorType(id=41,
