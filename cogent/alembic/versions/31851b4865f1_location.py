...
def upgrade():
    ...
    op.alter_column('Reading', 'type', 
               existing_type=mysql.INTEGER(display_width=11), 
               nullable=False)
    op.alter_column('Reading', 'nodeId', 
               existing_type=mysql.INTEGER(display_width=11), 
               nullable=False)
    op.alter_column('Reading', 'time', 
...
def downgrade():
    ...
    op.add_column('Node', sa.Column('roomId', mysql.INTEGER(display_width=11), nullable=True))
    op.add_column('Node', sa.Column('houseId', mysql.INTEGER(display_width=11), nullable=True))
    ...
    op.add_column('Reading', sa.Column('id', mysql.INTEGER(display_width=11), nullable=False))
    op.alter_column('Reading', 'type', 
               existing_type=mysql.INTEGER(display_width=11), 
               nullable=True)
    op.alter_column('Reading', 'nodeId', 
