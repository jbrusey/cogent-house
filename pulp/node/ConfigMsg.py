...
class ConfigMsg(tinyos.message.Message.Message):
    # Create a new ConfigMsg of size 114.
    ...
    def getElement_byType_configured(self, index1, index2):
        return self.getUIntElement(self.offsetBits_byType_configured(index1, index2), 8, 1)
    
    #
    # Set an element of the array 'byType.configured'
    #
    def setElement_byType_configured(self, index1, index2, value):
        self.setUIntElement(self.offsetBits_byType_configured(index1, index2), 8, value, 1)
