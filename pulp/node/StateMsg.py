...
DEFAULT_MESSAGE_SIZE = 73

# The Active Message type associated with this message.
AM_TYPE = 9

class StateMsg(tinyos.message.Message.Message):
    # Create a new StateMsg of size 73.
    def __init__(self, data="", addr=None, gid=None, base_offset=0, data_length=73):
